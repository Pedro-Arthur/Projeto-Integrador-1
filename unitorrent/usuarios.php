...
<head>
    ...
    <title>Usuários - UniTorrent</title>
...
<body>
    ...
    <div class="container mt-5">
        <h5 style="color: #007BFF;">Usuários Cadastrados</h5>
        <br/>
        <?php
        ...
        $result_usuarios = "SELECT * FROM cadastro ORDER BY id ASC";
        ...
        while ($row_usuarios = $resultado_usuarios->fetch(PDO::FETCH_ASSOC)) {
            echo "<strong>ID:</strong> " . $row_usuarios['id'] . "<br>";
            echo "<strong>Nome:</strong> " . $row_usuarios['nome'] . "<br>";
            echo "<strong>Apelido:</strong> " . $row_usuarios['apelido'] . "<br>";
            echo "<strong>Telefone:</strong> " . $row_usuarios['telefone'] . "<br>";
            echo "<strong>E-mail:</strong> " . $row_usuarios['email'] . "<br>";
            echo "<a href='editar.php?id=".$row_usuarios['id']."'>Editar</a><br><hr>";
        }
        ?>
