...
<body>
	...
	<div class="container mt-5">
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title" style="color: #007BFF;">Informações</h5>
				<p class="card-text"><?php echo "Nome: ". $_SESSION['nome']; ?></p>
				<p class="card-text"><?php echo "Apelido: ". $_SESSION['apelido']; ?></p>
				<p class="card-text"><?php echo "Telefone: ". $_SESSION['telefone']; ?></p>
				<p class="card-text"><?php echo "Email: ". $_SESSION['email']; ?></p>
				<p class="card-text"><?php echo "Senha: ". $_SESSION['senha']; ?> (senha criptografada)</p>
				<a href="sair.php" class="btn btn-danger">Sair</a>
				<a href="usuarios.php" class="btn btn-info">Editar perfil</a>
				<a href="registro.php" class="btn btn-success">Registrar filmes</a>
			</div>
		</div>
	</div>
