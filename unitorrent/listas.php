...
<body>
	...
	<div class="container">
		<div class="listas">
			...
			<?php
			$result_registro = "SELECT * FROM registro ORDER BY id ASC";
			$resultado_registro = $conn->prepare($result_registro);
			$resultado_registro->execute();

			while ($row_registro = $resultado_registro->fetch(PDO::FETCH_ASSOC)) {
				?>
				<div class="row">
					<div class="col-md-6">
						<div class="banner">
							<img src="<?php echo "uploads/" . $row_registro['id'] ?><?php echo "/" . $row_registro['imagem'] ?>" width="200px" height="300px">
						</div>
						<div class="conteudo">
							<p><strong>Nome: </strong><?php echo $row_registro['nome'] ?></p>
							<p><strong>Lançamento: </strong><?php echo $row_registro['lancamento'] ?></p>
							<p><strong>Direção: </strong><?php echo $row_registro['direcao'] ?></p>
							<p><strong>Produção: </strong><?php echo $row_registro['producao'] ?></p>
							<p><strong>Duração: </strong><?php echo $row_registro['duracao'] ?></p>
						</div>
					</div>
				</div>
				<?php
