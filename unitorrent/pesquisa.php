...
<head>
	...
	<title>Pesquisa - UniTorrent</title>
	...
	<div class="container">
		<div class="pesquisa">
			...
			if($SendPesq){
				...
				$result_pesquisa = "SELECT * FROM filmes WHERE nome LIKE '%$pesquisa%'";
				$resultado_pesquisa = mysqli_query($conn, $result_pesquisa);
				echo "<h5>Exibindo resultados para: $pesquisa</h5>";
					...
					<div class="row">
						<div class="col-md-6">
							<div class="card" style="width: 20rem;">
								<div class="card-body">
									<?php
									echo "<strong>Nome:</strong> " . $row_pesquisa['nome'] . "<br>";
									echo "<strong>Lançamento:</strong> " . $row_pesquisa['lancamento'] . "<br>";
									echo "<strong>Direção:</strong> " . $row_pesquisa['direcao'] . "<br>";
									echo "<strong>Produção:</strong> " . $row_pesquisa['producao'] . "<br>";
									echo "<strong>Duração:</strong> " . $row_pesquisa['duracao'] . "<br>";
									?>
									<a href="#">
